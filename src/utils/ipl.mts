...
export const loadIPLs = (): void => {
  ...
  // LABORATORIES
  var bike2IntId = game.getInteriorAtCoords(1051.491, -3196.536, -39.14842); //REQUEST
  alt.requestIpl("bkr_biker_interior_placement_interior_3_biker_dlc_int_ware02_milo"); //WEED
  ...
  var bike3IntId = game.getInteriorAtCoords(1093.6, -3196.6, -38.99841); //REQUEST
  alt.requestIpl("bkr_biker_interior_placement_interior_4_biker_dlc_int_ware03_milo"); //COCAIN
  ...
  game.refreshInterior(bike2IntId); //WEED
  game.refreshInterior(bike3IntId); //COCAIN
